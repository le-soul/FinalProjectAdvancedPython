...
class MainClass:
    """
    Main class for calling different functions based on user input
    """
    def plotter(plots, viewer, graphs, output):
        ...
        if plots:
            if graphs == "correlation":
                ...
                print(
                    "Invalid option for graph. Choose from: correlation, price skewness, most exp districts, most rooms districts, most bathrooms districs, price x variables"
                )
                return
    ...
    def regression(regression, linearregression, trainer, output):
        ...
        if regression:
            if linearregression == "regression":
                ...
                print(
                    "Invalid option for regression. Choose from: regression, multicollinearity+, predict your buying price"
                )
                return
