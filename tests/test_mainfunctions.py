...
class TestPlotter(unittest.TestCase):
    ...
    def test_plotter(self, print_mock, plt_mock):
        ...
        plt_mock.savefig.assert_called_once_with(os.path.join('outputs', 'correlation_matrix.png'))
        print_mock.assert_called_once_with(f"Graph saved at: {os.path.join('outputs', 'correlation_matrix.png')}")
    ...
    def test_regression(self, print_mock, plt_mock):
        ...
        plt_mock.savefig.assert_called_once_with(os.path.join('outputs', 'Linear_Regression.png'))
        print_mock.assert_called_once_with(f"Graph saved at: {os.path.join('outputs', 'Linear_Regression.png')}")
